...
const Query10 = () => {
    ...
    return (
    <Card className='my-3'>
        <Card.Header as="h5">Query 10</Card.Header>
        <Card.Body>
            <Card.Title>
            для людини H та кожного експерименту, у якому вона брала участь, знайти скiльки разiв
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <Row>
                    <Col md={3}>
                        <Form.Group controlId="Query10Form">
