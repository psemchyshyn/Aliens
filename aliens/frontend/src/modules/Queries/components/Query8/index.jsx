...
const Query8 = () => {
    ...
    return (
    <Card className='my-3'>
        <Card.Header as="h5">Query 8</Card.Header>
        <Card.Body>
            <Card.Title>
            знайти усi спiльнi екскурсiї та експерименти для прибульця A та людини H за вказаний
            перiод (з дати F по дату T);
            </Card.Title>
            <form onSubmit={handleSubmit(onSubmit)}>
                <Row>
                    <Col md={3}>
                        <Form.Group controlId="Query8Form">
